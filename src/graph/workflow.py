...
def create_workflow() -> StateGraph:
    ...
    try:
        ...
        log.info("Workflow graph created and compiled successfully.")
    except Exception as e:
        log.error(f"Error creating workflow graph: {e}")
        raise RuntimeError(f"Failed to create workflow graph: {e}") from e
